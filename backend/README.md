...
## Project Structure
    ...
    ├── testapiautostorybo_128603  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_128603`
...
2. Clone this repo and `cd testapiautostorybo_128603`
